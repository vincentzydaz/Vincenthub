...
local Window = ReGui:TabsWindow({
	Title = "Vincent Hub - ".. name .. " " .. scriptversion,
...
local l0 =info:Label({Text = "Made by Vincent Hub & KIRITO\ndiscord: vateq || https://discord.gg/eSHraNGV\n"})
...
info:Button({
	...
	Callback = function(self)
        ...
        modal("Join Discord?", "do you want to join\nvincenthub discord?",function()
                local discordInvite = "https://discord.gg/eSHraNGV"
